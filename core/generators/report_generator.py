...
class ReportGenerator:
    ...
    def generate_signal_matrix(self, data: DBCData, output_path: Path) -> GenerateResult:
        ...
        try:
            ...
            return GenerateResult(success=True, output_files=[Path(output_path)])
        except (OSError, ValueError) as exc:
            return GenerateResult(success=False, errors=[str(exc)])

    def generate_message_summary(self, data: DBCData, output_path: Path) -> GenerateResult:
    ...
    def generate_diff_report(self, diff: DBCDiffResult, output_path: Path) -> GenerateResult:
